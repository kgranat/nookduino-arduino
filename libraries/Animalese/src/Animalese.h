...
#ifndef _Animalese_h_
#define _Animalese_h_

#include <inttypes.h>

#define VERSION_ANIMALESE "1.0.4"
#define VERSION_ANIMALESE_NUMERICAL 104
...
public:
    ...
    Animalese(long userSpeechFrequency = 8000, long userSpeechPeriod = 25000);
    Animalese(bool aUseNonInvertedOutputPin, bool aUseInvertedOutputPin);
